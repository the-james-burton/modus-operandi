...
/**
 * Defines the operations required by the process monitor. It also specifies the security
 * settings to be applied.
 * 
 * The methods {@link #refresh()}, {@link #getEnvironment()}, {@link #getMachine()}, and
 * {@link #getProcesses()} don't have any associated security roles because they need to
